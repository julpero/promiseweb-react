...
describe("testing first round and first player", () => {
  ...
  test("getPlayableCardIndexes", () => {
    ...
    const myIndexes = getPlayableCardIndexes(myCards, firstRoundFirstPlayer.game.rounds[0], playIndex);
...
describe("testing first round and second player", () => {
  ...
  test("getPlayableCardIndexes", () => {
    ...
    const myIndexes = getPlayableCardIndexes(myCards, firstRoundSecondPlayer.game.rounds[0], playIndex);
...
describe("testing first round and second hit first player", () => {
  ...
  test("getPlayableCardIndexes", () => {
    ...
    const myIndexes = getPlayableCardIndexes(myCards, firstRoundSecondHitFirstPlayer.game.rounds[0], playIndex);
    expect(myIndexes).toContain(0);
    expect(myIndexes).toContain(1);
    expect(myIndexes).toContain(2);
    expect(myIndexes).toContain(3);
...
describe("testing first round and third hit second player", () => {
  ...
  test("getPlayableCardIndexes", () => {
    ...
    const myIndexes = getPlayableCardIndexes(myCards, firstRoundThirdHitSecondPlayer.game.rounds[0], playIndex);
    expect(myIndexes).toContain(0);
    expect(myIndexes).toContain(1);
    expect(myIndexes).toContain(2);
    expect(myIndexes).toContain(3);
