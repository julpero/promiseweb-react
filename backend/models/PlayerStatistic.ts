...
const playerStatisticSchema: Schema = new Schema<IPlayerStatistic>({
  ...
  totalPointsBig: {type: Number, required: true},
  totalPointsSmall: {type: Number, required: true},
  totalKeepsBig: {type: Number, required: true},
  totalKeepsSmall: {type: Number, required: true},
